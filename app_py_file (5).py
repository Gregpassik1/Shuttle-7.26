...
if st.session_state.data is not None:
    ...
    with tab2:
        ...
        st.plotly_chart(fig_monthly_trends, use_container_width=True, config=config)
        
        st.plotly_chart(fig_monthly_avg, use_container_width=True, config=config)
    ...
    with tab3:
        ...
        config = {'displayModeBar': False}
        st.plotly_chart(fig_shuttles, use_container_width=True, config=config)
    ...
    with tab3:
        ...
        with col1:
            ...
            config = {'displayModeBar': False}
            st.plotly_chart(fig_daily_cost, use_container_width=True, config=config)
